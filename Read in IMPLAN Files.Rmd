...
filename="AggTopTenIndustrybyEmployment Industry Code.csv"
...
filename="AggTopTenIndustrybyOutput Industry Code.csv"
fileNamewithPath <- file.path(data,indepvars,filename)
vars <-as_tibble(read_csv(fileNamewithPath))
shock01 <- inner_join(shock01,vars)
...
var_lab(shock01$IndustryTypebyOutput)="Primary Industry"
...
gf_lm(pctindirect ~ B_sd,data=(shock01 %>%
                                    filter(table=="Employment")),
               color=~as_label(IndustryTypebyOutput)) %>%
...
gf_density(~B_sd,
         ...
         fill=~ as_label(IndustryTypebyOutput),
